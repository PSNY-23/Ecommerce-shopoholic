    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <Link to='/cart' className='relative'>
          <img src={assets.cart_icon} alt='cart-icon' className='w-7 min-w-5' />
      ...
      >
        <div className='flex flex-col text-gray-600'>
          ...
          <NavLink onClick={() => setVisible(!visible)} className='pl-6 py-2 border' to='/'>
            HOME
          </NavLink>
          <NavLink onClick={() => setVisible(!visible)} className='pl-6 py-2 border' to='/collection'>
            COLLECTION
          </NavLink>
          <NavLink onClick={() => setVisible(!visible)} className='pl-6 py-2 border' to='/about'>
            ABOUT
          </NavLink>
          <NavLink onClick={() => setVisible(!visible)} className='pl-6 py-2 border' to='/contact'>
            CONTACT
          </NavLink>
        </div>
      </div>
