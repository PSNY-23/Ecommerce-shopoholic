...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // If you're uploading a file (for example, an image)
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      {/* Product category + sub-category + price*/}
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input
            ...
            value={price}
            className='w-full px-3 py-2 sm:w-32'
            type='number'
            placeholder='eg: 25'
          />
        </div>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          ...
          >
            <p className={`${sizes.includes("XXL") ? "bg-pink-300" : "bg-slate-200"} px-3 py-1 cursor-pointer `}>
              XXL+
            </p>
          </div>
        </div>
